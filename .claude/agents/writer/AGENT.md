...
8. 제목 후보 A/B/C를 함께 작성하여 Orchestrator에 전달한다.
   - **비전문가 친화 필수**: 세 후보 모두 AI 비전문가가 읽어도 즉시 이해할 수 있어야 한다.
   - 전문 용어(에이전트, 파일럿, RAG, MCP, 오케스트레이션 등)는 제목에 쓰지 않는다.
   - 독자가 "이거 우리 얘기다"라고 느낄 수 있는 일상 언어로 표현한다.
...
> 세 후보 모두 AI 비전문가가 읽어도 즉시 이해 가능해야 한다. 전문 용어 사용 금지.
