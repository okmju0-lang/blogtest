...
```bash
python .claude/skills/url-classifier/scripts/classify_url.py --urls "URL1,URL2,URL3"
# 또는 파일로 전달
python .claude/skills/url-classifier/scripts/classify_url.py --file urls.txt
```
