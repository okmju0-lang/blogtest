...
```bash
python .Codex/skills/pii-detector/scripts/detect_pii.py --file "output/drafts/post_id/draft_v1.md"
# 또는 텍스트 직접 전달
python .Codex/skills/pii-detector/scripts/detect_pii.py --text "검사할 텍스트"
```
